...
Je suis Syd, gestionnaire de nodes et validateur depuis quelques temps sur de nombreux projets crypto (Agoric, Stargaze, Stafi, Nyzo, Idena, Bismuth, Flux, Buzzer etc.) et, plus récemment, "GFM" (Genesis Founding Member) sur Mina. Lors des débuts du Mainnet, j'ai été sélectionné également durant le Testnet pour recevoir une délégation de la Fondation Mina (Top 100) et fais partie des "Community MVP". Par ailleurs, je suis actif sur de nombreux Discord cryptos FR tels que La Baleine, Crypto Sisyphe ou La Cryptosphère sur lesquels vous m'avez peut-être déjà croisé :smile: 
